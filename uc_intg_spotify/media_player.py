...
class SpotifyMediaPlayer:
    ...
    def __init__(self, api: ucapi.IntegrationAPI, client: SpotifyClient):
        ...
        self._api = api
        self._client = client
        self._config: SpotifyConfig = client._config if client else None # type: ignore
        ...
        self.entity = ucapi.MediaPlayer(
            ...
            cmd_handler=self.cmd_handler # type: ignore
        )
    ...
    async def clear_current_track(self) -> None:
        ...
        try:
            ...
            if self.entity.attributes.get(Attributes.STATE) != States.OFF:
                self._api.configured_entities.update_attributes(self.entity.id, attributes) # type: ignore

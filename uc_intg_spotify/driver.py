...
from media_player import SpotifyMediaPlayer
from remote import SpotifyRemote
from setup import SpotifySetup
...
async def on_setup_complete():
    ...
    if not api or not spotify_client:
        ...
        await api.set_device_state(ucapi.DeviceStates.ERROR) # type: ignore
        return
